...
bool tryNewPath(vector<int>& upgradePath, const vector<double>& resourceCounts, const vector<int>& currentLevels, double& finalScore){
    ...
    auxiliaryPath = generateRandomPath(TOTAL_SECONDS/3600);
